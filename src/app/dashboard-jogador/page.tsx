				...
				<main className={styles.mainContent}>
					<div className={styles.contentWrapper}>
						<div className={styles.sessionActions}>
							<input className={styles.sessionInput} placeholder='CÓDIGO DE CONVITE' />
							<div className={styles.sessionButtons}>
								<button className={styles.sessionButton}>ENTRAR NA SESSÃO</button>
								<button className={`${styles.sessionButton} ${styles.deleteButton}`}>SAIR DA CAMPANHA</button>
							</div>
						</div>
