...
export const Box = (): JSX.Element => {
	...
	return (
		<div style={{ display: 'flex', flexDirection: 'row', fontFamily: 'Cinzel, serif' }}>
			<div style={boxStyle}>
				{[
					...
					<div key={idx} style={shapeStyle}>
						<div style={topRectStyle}>
							<Image src={logo} alt={`Logo Shape ${idx + 1}`} width={logoSize} height={logoSize} />
						...
						<div style={contentContainerStyle}>
							...
							<div style={mapColumnStyle}>
								...
								<div style={statsItemStyle}>
									<Image src='/images/calendar.png' alt='Data' width={30} height={30} style={{ marginRight: '5px' }} />
			...
			<div ref={scrollbarRef} style={scrollBarStyle}>
				<div ref={thumbRef} style={thumbStyle} onMouseDown={handleMouseDown} />
			</div>
		</div>
	)
}
	...
	return (
		<>
			...
			<header className={styles.topBar}>
				...
				<h1 style={{ fontFamily: 'Cinzel, serif' }}>DASHBOARD DO MESTRE</h1>
			...
			<div className={styles.container}>
				<div className={styles.sidebar}>
					<div className={styles.logoContainer}>
						<Image src='/images/logo1.png' alt='EasyCrit Logo' width={250} height={250} className={styles.logo} />
					</div>

					<div className={styles.sidebarSection}>
						<h2 className={styles.sidebarTitle}></h2>
						<button className={styles.sidebarButton}>CRIAR CAMPANHA</button>
						<button className={`${styles.sidebarButton} ${styles.deleteButton}`}>EXCLUIR CAMPANHA</button>
					</div>
				</div>
